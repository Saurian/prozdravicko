...
namespace Devrun\DoctrineForms\Controls;

use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Devrun\DoctrineForms\EntityFormMapper;
use Devrun\DoctrineForms\IComponentMapper;
use Devrun\DoctrineForms\ToManyContainer;
...
//(dump($relation));
                $q = $UoW->getEntityIdentifier($entity);
//                die(dump($relation));
//                die(dump($entity));
//                die(dump($UoW));

//                $q = $UoW->getSingleIdentifierValue($relation);
//                dump($q);
